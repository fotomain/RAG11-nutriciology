"""LRM stage 3.3: upsert stage3_1_lrm_data/output into Supabase (lrm_sources, lrm_pages).
...
def main() -> int:
    ...
    if stale_sources:
        ...
        print(f"removed {len(stale_sources)} stale source(s) no longer in stage3_1_lrm_data/output")

    if not dirs:
        print("nothing in stage3_1_lrm_data/output -- run run1_lrm_eda.command first")
        return 1
