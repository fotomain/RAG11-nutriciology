...
- A "Summary Content List" block (pages 5-6, 0-based) is the book's own
  ...
  the same way source2 trusts its printed TOC over a heuristic heading
...
- A handful of chapters (verified: 6 of 14) have a "Critical Thinking"
  ...
  block_type "critical_thinking", same pattern as source2's Safety Alert /
...
EXPECTED_PAGES = 181
STRUCTURE = "regex_chapter_summary"  # no outline; Bookey-style condensed chapter summaries
