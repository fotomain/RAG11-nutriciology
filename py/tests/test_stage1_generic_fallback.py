"""Offline test for eda_packages.generic_fallback using tiny synthetic PDFs.
...
sys.path.insert(0, ".")
from eda_packages import process_source  # noqa: E402
...
with tempfile.TemporaryDirectory() as tmp:
    root = Path(tmp)
    pdf_dir = root / "eda_input" / "source1"
    ...
    check("font headings: cache written", (root / "eda_output" / "source1" / "_cache_headings.json").exists())
    ...
    from eda_packages import FILENAME_PROCESSORS
