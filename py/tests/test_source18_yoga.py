"""Tests for eda_packages/source18_yoga_sutra_angot.py.
Unit tests run offline; the integration test needs the real PDF in eda_input/ and is skipped otherwise.
...
sys.path.insert(0, ".")
from eda_packages import FILENAME_PROCESSORS, KNOWN_SOURCE_EDA_META, process_source  # noqa: E402
from eda_packages import source18_yoga_sutra_angot as y  # noqa: E402
...
matches = glob.glob("eda_input/*/Yogasutra*.pdf")
if not matches:
