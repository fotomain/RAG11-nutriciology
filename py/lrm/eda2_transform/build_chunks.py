#!/usr/bin/env python3
"""LRM stage 3.4: chunk + embed every uploaded lrm_page_table row into lrm_child_chunk_table.
Deterministic uuid5 ids make reruns idempotent. Reads from Supabase (not local disk) --
lrm_page_table is already the single source of truth once upload.py has run.
